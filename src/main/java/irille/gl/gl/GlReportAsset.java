...
public class GlReportAsset extends BeanLong<GlReportAsset> {
	public static final Tb TB = new Tb(GlReportAsset.class, "资产负债表").setAutoIncrement().addActIns().addActDel()

...
public class GlReportAssetLine extends BeanLong<GlReportAssetLine>{
	public static final Tb TB = new Tb(GlReportAssetLine.class, "资产负债表明细").setAutoLocal()
	    .addActList();

	public enum T implements IEnumFld {//@formatter:off
		PKEY(TB.crtLongPkey()),  //此表主键类似Form的主键进行编号
		ASSET_REPORT(TB.crtOutKey(GlReportAsset.class, "assetReport", "资产负债表")),
  ...
  private Long _assetReport;	// 资产负债表 <表主键:GlReportAsset>  LONG
  ...
  private Short _rowVersion;	// 版本  SHORT
	...
	@Override
  public GlReportAssetLine init(){
		super.init();
    _assetReport=null;	// 资产负债表 <表主键:GlReportAsset>  LONG
  ...
  public Long getAssetReport(){
    return _assetReport;
  }
  public void setAssetReport(Long assetReport){
    _assetReport=assetReport;
  }
  public GlReportAsset gtAssetReport(){
    if(getAssetReport()==null)
      return null;
    return (GlReportAsset)get(GlReportAsset.class,getAssetReport());
  }
  public void stAssetReport(GlReportAsset assetReport){
    if(assetReport==null)
      setAssetReport(null);
    else
      setAssetReport(assetReport.getPkey());
  }

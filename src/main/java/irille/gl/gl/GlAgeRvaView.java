 ...
 */
public class GlAgeRvaView extends BeanLong<GlAgeRvaView> {
	public static final Tb TB = new TbView(GlAgeRvaView.class, "应收账龄").setAutoLocal().addActList();

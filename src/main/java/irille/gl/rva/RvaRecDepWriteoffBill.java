...
public class RvaRecDepWriteoffBill extends BeanBill<RvaRecDepWriteoffBill> {
	public static final Tb TB = new Tb(RvaRecDepWriteoffBill.class, "预收核销单", BeanBill.TB).setAutoIncrement().addActIUDL()
  ...
  private Short _rowVersion;	// 版本  SHORT
	...
	@Override
  public RvaRecDepWriteoffBill init(){
		super.init();
  ...
  //方法----------------------------------------------
  public static RvaRecDepWriteoffBill loadUniqueCode(boolean lockFlag,String code) {
    return (RvaRecDepWriteoffBill)loadUnique(T.IDX_CODE,lockFlag,code);
  }
  public static RvaRecDepWriteoffBill chkUniqueCode(boolean lockFlag,String code) {
    return (RvaRecDepWriteoffBill)chkUnique(T.IDX_CODE,lockFlag,code);
  }
  public Long getPkey(){
    return _pkey;
  }

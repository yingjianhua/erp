...
public class RvaNoteCashOnDeliveryLine extends BeanLong<RvaNoteCashOnDeliveryLine> {
	public static final Tb TB = new Tb(RvaNoteCashOnDeliveryLine.class, "货到付款核销凭条").setAutoIncrement();

	public enum T implements IEnumFld {//@formatter:off
		CMB_WRITEOFF_LINE(CmbWriteoffLine.fldFlds()), 
		MAIN_NOTE(Tb.crtOutKey(PyaNoteAccountPayable.class, "mainNote", "货到付款凭条")),
  ...
  private Long _mainNote;	// 货到付款凭条 <表主键:PyaNoteAccountPayable>  LONG
  private Short _rowVersion;	// 版本  SHORT

	@Override
  public RvaNoteCashOnDeliveryLine init(){
		super.init();
    _tallyDate=null;	// 记账日期  DATE
    _mainNote=null;	// 货到付款凭条 <表主键:PyaNoteAccountPayable>  LONG

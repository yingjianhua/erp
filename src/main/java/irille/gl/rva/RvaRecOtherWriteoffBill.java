...
public class RvaRecOtherWriteoffBill extends BeanBill<RvaRecOtherWriteoffBill> {
	public static final Tb TB = new Tb(RvaRecOtherWriteoffBill.class, "其它应收核销单", BeanBill.TB).setAutoIncrement().addActIUDL()
  ...
  private Short _rowVersion;	// 版本  SHORT
	...
	@Override
  public RvaRecOtherWriteoffBill init(){
		super.init();
  ...
  //方法----------------------------------------------
  public static RvaRecOtherWriteoffBill loadUniqueCode(boolean lockFlag,String code) {
    return (RvaRecOtherWriteoffBill)loadUnique(T.IDX_CODE,lockFlag,code);
  }
  public static RvaRecOtherWriteoffBill chkUniqueCode(boolean lockFlag,String code) {
    return (RvaRecOtherWriteoffBill)chkUnique(T.IDX_CODE,lockFlag,code);
  }
  public Long getPkey(){
    return _pkey;
  }

...
public class RvaRecOtherBill extends BeanBill<RvaRecOtherBill> {
	public static final Tb TB = new Tb(RvaRecOtherBill.class, "其它应收单", BeanBill.TB).setAutoIncrement().addActIUDL()
  ...
  //方法----------------------------------------------
  public static RvaRecOtherBill loadUniqueCode(boolean lockFlag,String code) {
    return (RvaRecOtherBill)loadUnique(T.IDX_CODE,lockFlag,code);
  }
  public static RvaRecOtherBill chkUniqueCode(boolean lockFlag,String code) {
    return (RvaRecOtherBill)chkUnique(T.IDX_CODE,lockFlag,code);
  }
  public Long getPkey(){
    return _pkey;
  }

...
public class RvaNoteOtherLine extends BeanLong<RvaNoteOtherLine> implements IWriteoff {
	public static final Log LOG = new Log(RvaNoteOtherLine.class);
	public static final Tb TB = new Tb(RvaNoteOtherLine.class, "其它应收款核销凭条");

	public enum T implements IEnumFld {//@formatter:off
		CMB_WRITEOFF_LINE(CmbWriteoffLine.fldFlds()), 
		MAIN_NOTE(Tb.crtOutKey(RvaNoteOther.class, "mainNote", "其它应收款")),
	...
	public void tallyWriteoff(GlNote note) {
		RvaNoteOther write = loadAndLock(RvaNoteOther.class, getMainNote());
  ...
  private Long _mainNote;	// 其它应收款 <表主键:RvaNoteOther>  LONG
  private Short _rowVersion;	// 版本  SHORT

	@Override
  public RvaNoteOtherLine init(){
		super.init();
    _tallyDate=null;	// 记账日期  DATE
    _mainNote=null;	// 其它应收款 <表主键:RvaNoteOther>  LONG
  ...
  public RvaNoteOther gtMainNote(){
    if(getMainNote()==null)
      return null;
    return (RvaNoteOther)get(RvaNoteOther.class,getMainNote());
  }
  public void stMainNote(RvaNoteOther mainNote){
    if(mainNote==null)
      setMainNote(null);
    else

...
public class RvaNoteCashOnDelivery extends BeanLong<RvaNoteCashOnDelivery> implements IWrite{
	private static final Log LOG = new Log(RvaNoteCashOnDelivery.class);

	public static final Tb TB = new Tb(RvaNoteCashOnDelivery.class, "货到付款凭条")
			.addActIUDL();
...
//			TB.addIndex("journalStateTallyDate",false,JOURNAL,STATE,TALLY_DATE);
	...
	public void tallyCancel(GlNote note) {
		if (getBalance().compareTo(note.getAmt()) != 0 && Idu.chkBeUsed(RvaNoteCashOnDeliveryLine.class, RvaNoteCashOnDeliveryLine.T.MAIN_NOTE, getPkey()))
  ...
  private Short _rowVersion;	// 版本  SHORT
	...
	@Override
  public RvaNoteCashOnDelivery init(){
		super.init();

...
public class RvaRecWriteoffBill extends BeanBill<RvaRecWriteoffBill> {
	public static final Tb TB = new Tb(RvaRecWriteoffBill.class, "应收核销单", BeanBill.TB).setAutoIncrement().addActIUDL()
  ...
  private Short _rowVersion;	// 版本  SHORT
	...
	@Override
  public RvaRecWriteoffBill init(){
		super.init();
  ...
  //方法----------------------------------------------
  public static RvaRecWriteoffBill loadUniqueCode(boolean lockFlag,String code) {
    return (RvaRecWriteoffBill)loadUnique(T.IDX_CODE,lockFlag,code);
  }
  public static RvaRecWriteoffBill chkUniqueCode(boolean lockFlag,String code) {
    return (RvaRecWriteoffBill)chkUnique(T.IDX_CODE,lockFlag,code);
  }
  public Long getPkey(){
    return _pkey;
  }

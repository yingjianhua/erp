...
public class RvaNoteDepositLine extends BeanLong<RvaNoteDepositLine> implements IWriteoff {
	public static final Log LOG = new Log(RvaNoteDepositLine.class);
	public static final Tb TB = new Tb(RvaNoteDepositLine.class, "预收账款核销凭条");

	public enum T implements IEnumFld {//@formatter:off
		CMB_WRITEOFF_LINE(CmbWriteoffLine.fldFlds()), 
		MAIN_NOTE(Tb.crtOutKey(RvaNoteDeposit.class, "mainNote", "预收账款")),
	...
	public void tallyWriteoff(GlNote note) {
		RvaNoteDeposit write = loadAndLock(RvaNoteDeposit.class, getMainNote());
  ...
  private Long _mainNote;	// 预收账款 <表主键:RvaNoteDeposit>  LONG
  private Short _rowVersion;	// 版本  SHORT

	@Override
  public RvaNoteDepositLine init(){
		super.init();
    _tallyDate=null;	// 记账日期  DATE
    _mainNote=null;	// 预收账款 <表主键:RvaNoteDeposit>  LONG
  ...
  public RvaNoteDeposit gtMainNote(){
    if(getMainNote()==null)
      return null;
    return (RvaNoteDeposit)get(RvaNoteDeposit.class,getMainNote());
  }
  public void stMainNote(RvaNoteDeposit mainNote){
    if(mainNote==null)
      setMainNote(null);
    else

...
public class RvaRecDepBill extends BeanBill<RvaRecDepBill> {
	public static final Tb TB = new Tb(RvaRecDepBill.class, "预收单", BeanBill.TB).setAutoIncrement().addActIUDL()
  ...
  //方法----------------------------------------------
  public static RvaRecDepBill loadUniqueCode(boolean lockFlag,String code) {
    return (RvaRecDepBill)loadUnique(T.IDX_CODE,lockFlag,code);
  }
  public static RvaRecDepBill chkUniqueCode(boolean lockFlag,String code) {
    return (RvaRecDepBill)chkUnique(T.IDX_CODE,lockFlag,code);
  }
  public Long getPkey(){
    return _pkey;
  }

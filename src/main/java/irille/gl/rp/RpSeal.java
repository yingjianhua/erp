 ...
 *
 */
public class RpSeal extends BeanInt<RpSeal> {
	private static final Log LOG = new Log(RpSeal.class);

	public static final Tb TB = new Tb(RpSeal.class, "印章").setAutoIncrement().addActIUDL().addActEnabled();
	...
	public enum T implements IEnumFld {//@formatter:off
		...
		public static final Index IDX_USER = TB.addIndex("user", false, USER_SYS);
		private Fld _fld;

...
public class RpNoteRptBill extends BeanBill<RpNoteRptBill> {
	public static final Tb TB = new Tb(RpNoteRptBill.class, "收款单", BeanBill.TB).setAutoIncrement().addActIUDL()
  ...
  //方法----------------------------------------------
  public static RpNoteRptBill loadUniqueCode(boolean lockFlag,String code) {
    return (RpNoteRptBill)loadUnique(T.IDX_CODE,lockFlag,code);
  }
  public static RpNoteRptBill chkUniqueCode(boolean lockFlag,String code) {
    return (RpNoteRptBill)chkUnique(T.IDX_CODE,lockFlag,code);
  }
  public Long getPkey(){
    return _pkey;
  }

...
public class RpStimatePay extends BeanLong {
	public static final Tb TB = new Tb(RpStimatePay.class, "待付款登记").setAutoIncrement().addActList()
	    .addActOpt("doProc", "付款").addActOpt("unProc", "付款取消");
  ...
  //方法----------------------------------------------
  public static RpStimatePay loadUniqueForm(boolean lockFlag,Long origForm) {
    return (RpStimatePay)loadUnique(T.IDX_FORM,lockFlag,origForm);
  }
  public static RpStimatePay chkUniqueForm(boolean lockFlag,Long origForm) {
    return (RpStimatePay)chkUnique(T.IDX_FORM,lockFlag,origForm);
  }
  public Long getPkey(){
    return _pkey;
  }

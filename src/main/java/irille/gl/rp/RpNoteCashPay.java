...
public class RpNoteCashPay extends BeanLong<RpNoteCashPay> { //implements ICmbRpRpt{
	private static final Log LOG = new Log(RpNoteCashPay.class);

	public static final Tb TB = new Tb(RpNoteCashPay.class, "现金付款凭条").addActIUDL();

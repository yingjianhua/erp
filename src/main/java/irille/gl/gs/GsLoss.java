...
public class GsLoss extends BeanForm<GsLoss> implements ICstInout{
	public static final Tb TB = new Tb(GsLoss.class, "盘亏单", "盘亏单").setAutoIncrement().addActIUDL().addActApprove().addActPrint();

	public enum T implements IEnumFld {//@formatter:off
		CMB_FORM(CmbForm.fldFlds()),
		WAREHOUSE(GsWarehouse.fldOutKey()),
		ORIG_FORM(SYS.FORM, "源单据",true),
		ORIG_FORM_NUM(SYS.FORM_NUM, "源单据号", true),
	...
	public List<IGoods> getCstInoutLines(int type) {
		 return Idu.getLinesTid(this, GsLossLine.class);
	}
	//@formatter:on
  ...
  //方法----------------------------------------------
  public static GsLoss loadUniqueCode(boolean lockFlag,String code) {
    return (GsLoss)loadUnique(T.IDX_CODE,lockFlag,code);
  }
  public static GsLoss chkUniqueCode(boolean lockFlag,String code) {
    return (GsLoss)chkUnique(T.IDX_CODE,lockFlag,code);
  }
  public static GsLoss loadUniqueOrig(boolean lockFlag,Long origForm) {
    return (GsLoss)loadUnique(T.IDX_ORIG,lockFlag,origForm);
  }
  public static GsLoss chkUniqueOrig(boolean lockFlag,Long origForm) {
    return (GsLoss)chkUnique(T.IDX_ORIG,lockFlag,origForm);
  }
  public Long getPkey(){
    return _pkey;
  }

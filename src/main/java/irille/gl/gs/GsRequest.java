...
public class GsRequest extends BeanForm<GsRequest> {
	public static final Tb TB = new Tb(GsRequest.class, "请购单", "请购单").setAutoIncrement().addActIUDL().addActApprove();
  ...
  //方法----------------------------------------------
  public static GsRequest loadUniqueCode(boolean lockFlag,String code) {
    return (GsRequest)loadUnique(T.IDX_CODE,lockFlag,code);
  }
  public static GsRequest chkUniqueCode(boolean lockFlag,String code) {
    return (GsRequest)chkUnique(T.IDX_CODE,lockFlag,code);
  }
  public Long getPkey(){
    return _pkey;
  }

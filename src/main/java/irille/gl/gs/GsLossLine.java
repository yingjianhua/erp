...
public class GsLossLine extends BeanGoods<GsLossLine> {
	public static final Tb TB = new Tb(GsLossLine.class, "盘亏单明细", "盘亏单明细").setAutoLocal();

	public enum T implements IEnumFld {//@formatter:off
		CMB_FORM(CmbGoods.fldFlds()),

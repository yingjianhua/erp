 ...
 */
public class GsInLineView extends BeanGoods<GsInLineView> {
	public static final Tb TB = new TbView(GsInLineView.class, "入库单明细", "入库单明细").setAutoLocal();

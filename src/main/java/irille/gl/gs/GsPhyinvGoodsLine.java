...
public class GsPhyinvGoodsLine extends BeanLong<GsPhyinvGoodsLine> {
	public static final Tb TB = new Tb(GsPhyinvGoodsLine.class, "盘点商品明细").setAutoLocal();

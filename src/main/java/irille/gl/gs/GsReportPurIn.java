...
public class GsReportPurIn extends BeanLong<GsReportPurIn> {
	public static final Tb TB = new TbView(GsReportPurIn.class, "采购入库报表	").setAutoLocal().addActList();
	
	public enum T implements IEnumFld {//@formatter:off
		CODE(SYS.CODE__40,"入库单号"),	//出库单号
		In_TIME(SYS.DATE_TIME,"入库时间"),	//出库时间
  ...
  //实例变量定义-----------------------------------------
  private String _code;	// 入库单号  STR(40)
  private Date _inTime;	// 入库时间  TIME
  ...
  private BigDecimal _qty;	// 数量  DEC(14,4)
	...
	@Override
  public GsReportPurIn init(){
		super.init();
    _code=null;	// 入库单号  STR(40)
    _inTime=Env.getTranBeginTime();	// 入库时间  TIME

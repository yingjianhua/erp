...
public class GsOut extends BeanForm<GsOut> implements IForm {
	public static final Tb TB = new Tb(GsOut.class, "出库单", "出库单").setAutoIncrement().addActList().addActApprove().addActPrint();
	...
	public enum T implements IEnumFld {//@formatter:off
		...
		OUT_TIME(SYS.DATE_TIME__NULL,"实际出库时间"),
  ...
  private Date _outTime;	// 实际出库时间  TIME<null>
  ...
  //方法----------------------------------------------
  public static GsOut loadUniqueCode(boolean lockFlag,String code) {
    return (GsOut)loadUnique(T.IDX_CODE,lockFlag,code);
  }
  public static GsOut chkUniqueCode(boolean lockFlag,String code) {
    return (GsOut)chkUnique(T.IDX_CODE,lockFlag,code);
  }
  public static GsOut loadUniqueOrig(boolean lockFlag,Long origForm) {
    return (GsOut)loadUnique(T.IDX_ORIG,lockFlag,origForm);
  }
  public static GsOut chkUniqueOrig(boolean lockFlag,Long origForm) {
    return (GsOut)chkUnique(T.IDX_ORIG,lockFlag,origForm);
  }
  public Long getPkey(){
    return _pkey;
  }

...
public class GsMovementLine extends BeanGoods<GsMovementLine> {
	public static final Tb TB = new Tb(GsMovementLine.class, "内部调拨单明细", "内部调拨单明细").setAutoLocal();

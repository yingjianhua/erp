...
public class GsReportMvOut extends BeanLong<GsReportMvOut> {
	public static final Tb TB = new TbView(GsReportMvOut.class, "调拨出库报表").setAutoLocal().addActList();

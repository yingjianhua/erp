...
public class GsSplitLine extends BeanGoods<GsSplitLine> {
	public static final Tb TB = new Tb(GsSplitLine.class, "拆分单明细").setAutoLocal().addActIUDL();

	public enum T implements IEnumFld {//@formatter:off
		CMB_GOODS_COST(CmbGoods.fldFlds()),

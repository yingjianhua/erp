...
public class GsRequestLine extends BeanGoods<GsRequestLine> {
	public static final Tb TB = new Tb(GsRequestLine.class, "请购单明细", "请购单明细").setAutoLocal();

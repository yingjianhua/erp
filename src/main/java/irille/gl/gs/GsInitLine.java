...
public class GsInitLine extends BeanGoodsPrice<GsInitLine> {
	public static final Tb TB = new Tb(GsInitLine.class, "期初库存单明细", "期初库存单明细").setAutoLocal();

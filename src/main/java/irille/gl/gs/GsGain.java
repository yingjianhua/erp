...
public class GsGain extends BeanForm<GsGain> implements ICstInout{
	public static final Tb TB = new Tb(GsGain.class, "盘盈单", "盘盈单").setAutoIncrement().addActIUDL().addActApprove().addActPrint();

	public enum T implements IEnumFld {//@formatter:off
		CMB_FORM(CmbForm.fldFlds()),
		WAREHOUSE(GsWarehouse.fldOutKey()),
		ORIG_FORM(SYS.ORIG_FORM__CODE, true),
	...
	public List<IGoods> getCstInoutLines(int type) {
		 return Idu.getLinesTid(this, GsGainLine.class);
	}
	//@formatter:on
  ...
  //方法----------------------------------------------
  public static GsGain loadUniqueCode(boolean lockFlag,String code) {
    return (GsGain)loadUnique(T.IDX_CODE,lockFlag,code);
  }
  public static GsGain chkUniqueCode(boolean lockFlag,String code) {
    return (GsGain)chkUnique(T.IDX_CODE,lockFlag,code);
  }
  public static GsGain loadUniqueOrig(boolean lockFlag,Long origForm) {
    return (GsGain)loadUnique(T.IDX_ORIG,lockFlag,origForm);
  }
  public static GsGain chkUniqueOrig(boolean lockFlag,Long origForm) {
    return (GsGain)chkUnique(T.IDX_ORIG,lockFlag,origForm);
  }
  public Long getPkey(){
    return _pkey;
  }

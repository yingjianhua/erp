...
public class PyaPayDepWriteoffBill extends BeanBill<PyaPayDepWriteoffBill> {
	public static final Tb TB = new Tb(PyaPayDepWriteoffBill.class, "预付核销单", BeanBill.TB).setAutoIncrement().addActIUDL()
  ...
  private Short _rowVersion;	// 版本  SHORT
	...
	@Override
  public PyaPayDepWriteoffBill init(){
		super.init();
  ...
  //方法----------------------------------------------
  public static PyaPayDepWriteoffBill loadUniqueCode(boolean lockFlag,String code) {
    return (PyaPayDepWriteoffBill)loadUnique(T.IDX_CODE,lockFlag,code);
  }
  public static PyaPayDepWriteoffBill chkUniqueCode(boolean lockFlag,String code) {
    return (PyaPayDepWriteoffBill)chkUnique(T.IDX_CODE,lockFlag,code);
  }
  public Long getPkey(){
    return _pkey;
  }

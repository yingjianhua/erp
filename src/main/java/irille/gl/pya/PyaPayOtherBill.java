...
public class PyaPayOtherBill extends BeanBill<PyaPayOtherBill> {
	public static final Tb TB = new Tb(PyaPayOtherBill.class, "其它应付单", BeanBill.TB).setAutoIncrement().addActIUDL()
  ...
  //方法----------------------------------------------
  public static PyaPayOtherBill loadUniqueCode(boolean lockFlag,String code) {
    return (PyaPayOtherBill)loadUnique(T.IDX_CODE,lockFlag,code);
  }
  public static PyaPayOtherBill chkUniqueCode(boolean lockFlag,String code) {
    return (PyaPayOtherBill)chkUnique(T.IDX_CODE,lockFlag,code);
  }
  public Long getPkey(){
    return _pkey;
  }

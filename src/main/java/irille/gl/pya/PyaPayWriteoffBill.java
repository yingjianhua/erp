...
public class PyaPayWriteoffBill extends BeanBill<PyaPayWriteoffBill> {
	public static final Tb TB = new Tb(PyaPayWriteoffBill.class, "应付核销单", BeanBill.TB).setAutoIncrement().addActIUDL()
  ...
  private Short _rowVersion;	// 版本  SHORT
	...
	@Override
  public PyaPayWriteoffBill init(){
		super.init();
  ...
  //方法----------------------------------------------
  public static PyaPayWriteoffBill loadUniqueCode(boolean lockFlag,String code) {
    return (PyaPayWriteoffBill)loadUnique(T.IDX_CODE,lockFlag,code);
  }
  public static PyaPayWriteoffBill chkUniqueCode(boolean lockFlag,String code) {
    return (PyaPayWriteoffBill)chkUnique(T.IDX_CODE,lockFlag,code);
  }
  public Long getPkey(){
    return _pkey;
  }

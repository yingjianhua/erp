...
public class PyaPayOtherWriteoffBill extends BeanBill<PyaPayOtherWriteoffBill> {
	public static final Tb TB = new Tb(PyaPayOtherWriteoffBill.class, "其它应付核销单", BeanBill.TB).setAutoIncrement().addActIUDL()
  ...
  private Short _rowVersion;	// 版本  SHORT
	...
	@Override
  public PyaPayOtherWriteoffBill init(){
		super.init();
  ...
  //方法----------------------------------------------
  public static PyaPayOtherWriteoffBill loadUniqueCode(boolean lockFlag,String code) {
    return (PyaPayOtherWriteoffBill)loadUnique(T.IDX_CODE,lockFlag,code);
  }
  public static PyaPayOtherWriteoffBill chkUniqueCode(boolean lockFlag,String code) {
    return (PyaPayOtherWriteoffBill)chkUnique(T.IDX_CODE,lockFlag,code);
  }
  public Long getPkey(){
    return _pkey;
  }

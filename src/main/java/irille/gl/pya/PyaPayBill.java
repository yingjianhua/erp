...
public class PyaPayBill extends BeanBill<PyaPayBill> {
	public static final Tb TB = new Tb(PyaPayBill.class, "应付单", BeanBill.TB).setAutoIncrement().addActIUDL()
  ...
  //方法----------------------------------------------
  public static PyaPayBill loadUniqueCode(boolean lockFlag,String code) {
    return (PyaPayBill)loadUnique(T.IDX_CODE,lockFlag,code);
  }
  public static PyaPayBill chkUniqueCode(boolean lockFlag,String code) {
    return (PyaPayBill)chkUnique(T.IDX_CODE,lockFlag,code);
  }
  public Long getPkey(){
    return _pkey;
  }

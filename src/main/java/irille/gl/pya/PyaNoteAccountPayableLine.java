...
public class PyaNoteAccountPayableLine extends BeanLong<PyaNoteAccountPayableLine> implements IWriteoff {
	public static final Log LOG = new Log(PyaNoteAccountPayableLine.class);
	public static final Tb TB = new Tb(PyaNoteAccountPayableLine.class, "应付账款核销凭条");

	public enum T implements IEnumFld {//@formatter:off
		CMB_WRITEOFF_LINE(CmbWriteoffLine.fldFlds()), 
		MAIN_NOTE(Tb.crtOutKey(PyaNoteAccountPayable.class, "mainNote", "应付账款")),
	...
	public void tallyWriteoff(GlNote note) {
		PyaNoteAccountPayable write = loadAndLock(PyaNoteAccountPayable.class, getMainNote());
  ...
  private Long _mainNote;	// 应付账款 <表主键:PyaNoteAccountPayable>  LONG
  private Short _rowVersion;	// 版本  SHORT

	@Override
  public PyaNoteAccountPayableLine init(){
		super.init();
    _tallyDate=null;	// 记账日期  DATE
    _mainNote=null;	// 应付账款 <表主键:PyaNoteAccountPayable>  LONG
  ...
  public PyaNoteAccountPayable gtMainNote(){
    if(getMainNote()==null)
      return null;
    return (PyaNoteAccountPayable)get(PyaNoteAccountPayable.class,getMainNote());
  }
  public void stMainNote(PyaNoteAccountPayable mainNote){
    if(mainNote==null)
      setMainNote(null);
    else

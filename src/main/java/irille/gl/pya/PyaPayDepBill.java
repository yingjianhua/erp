...
public class PyaPayDepBill extends BeanBill<PyaPayDepBill> {
	public static final Tb TB = new Tb(PyaPayDepBill.class, "预付单", BeanBill.TB).setAutoIncrement().addActIUDL()
  ...
  //方法----------------------------------------------
  public static PyaPayDepBill loadUniqueCode(boolean lockFlag,String code) {
    return (PyaPayDepBill)loadUnique(T.IDX_CODE,lockFlag,code);
  }
  public static PyaPayDepBill chkUniqueCode(boolean lockFlag,String code) {
    return (PyaPayDepBill)chkUnique(T.IDX_CODE,lockFlag,code);
  }
  public Long getPkey(){
    return _pkey;
  }

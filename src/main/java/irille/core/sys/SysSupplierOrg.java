...
public class SysSupplierOrg extends BeanInt<SysSupplierOrg> {

	public static final Tb TB = new Tb(SysSupplierOrg.class, "供应商机构对照表")
			.setAutoIncrement().addActIUDL();

	public enum T implements IEnumFld {//@formatter:off
		PKEY(TB.crtIntPkey()), 
		SUPPLIER(SysSupplier.fldOutKey()), 
		ORG(SYS.ORG),
		DEPT(SYS.DEPT, true),

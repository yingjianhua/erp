...
import irille.dep.pya.EPyaPayOtherWriteoffBill;
...
public class ERvaRecOtherWriteoffBill extends RvaRecOtherWriteoffBill {
	public static void main(String[] args) {
		new ERvaRecOtherWriteoffBill().crtExt().crtFiles();
		;
	}
	...
	class MyForm extends EMForm<MyForm> {
		...
		public void initComponent(ExtFunDefine fun) {
			fun.add(loadFunCode(ERvaRecOtherWriteoffBill.class, "initComponentMy",getPack(),getClazz()));
			//@formatter:off

...
public class EGlReportAsset extends GlReportAsset{
	public static void main(String[] args) {
	// 	new EGlReportAsset().crtExt().crtFiles();
	}
	...
	public EMCrt crtExt() {
		...
		MyComp ext = new MyComp(TB, vflds, vflds, searchVflds, new VFlds[]{new VFlds(GlReportAssetLine.TB)});
		ext.newExts().init();
		return ext;
	}

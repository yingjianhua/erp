...
public class EPyaPayOtherBill extends PyaPayOtherBill {
	public static void main(String[] args) {
		new EPyaPayOtherBill().crtExt().crtFiles();
		;
	}
	...
	class MyForm extends EMForm<MyForm> {
		...
		public void initComponent(ExtFunDefine fun) {
			fun.add(loadFunCode(EPyaPayOtherBill.class, "initComponentMy",getPack(),getClazz()));
			//@formatter:off

...
public class EPyaPayDepBill extends PyaPayDepBill {
	public static void main(String[] args) {
		new EPyaPayDepBill().crtExt().crtFiles();
		;
	}
	...
	class MyForm extends EMForm<MyForm> {
		...
		public void initComponent(ExtFunDefine fun) {
			fun.add(loadFunCode(EPyaPayDepBill.class, "initComponentMy",getPack(),getClazz()));
			//@formatter:off

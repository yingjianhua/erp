...
public class EPyaPayDepWriteoffBill extends PyaPayDepWriteoffBill {
	public static void main(String[] args) {
		new EPyaPayDepWriteoffBill().crtExt().crtFiles();
		;
	}
	...
	class MyForm extends EMForm<MyForm> {
		...
		public void initComponent(ExtFunDefine fun) {
			fun.add(loadFunCode(EPyaPayDepWriteoffBill.class, "initComponentMy",getPack(),getClazz()));
			//@formatter:off

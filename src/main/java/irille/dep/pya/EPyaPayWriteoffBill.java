...
public class EPyaPayWriteoffBill extends PyaPayWriteoffBill {
	public static void main(String[] args) {
		new EPyaPayWriteoffBill().crtExt().crtFiles();
		;
	}
	...
	class MyForm extends EMForm<MyForm> {
		...
		public void initComponent(ExtFunDefine fun) {
			fun.add(loadFunCode(EPyaPayWriteoffBill.class, "initComponentMy",getPack(),getClazz()));
			//@formatter:off

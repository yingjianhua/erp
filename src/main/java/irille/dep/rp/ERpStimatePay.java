...
public class ERpStimatePay extends RpStimatePay {

	public static void main(String[] args) {
		new ERpStimatePay().crtExt().crtFiles();
	}
	...
	class MyList extends EMZipList {
		...
		public void initFuns() {
			AddFun("onDoProcRecord", ERpStimatePay.class).addFunParasExp("form, data");
			super.initFuns();
		}
		...
		public void loadTbAct(Class funCodeFile, Act act) {
			...
			if (act.getCode().equals("doProc") == false && act.getCode().equals("unProc") == false)
				return;
			ExtAct v = new ExtAct(this, act, ERpStimatePay.class);
		...
		public void initFormListMain() {
			...
			l.addExp("listeners", loadFunCode(ERpStimatePay.class, "selectionchange", getOutVFlds().get(0).getCode()));
		}

 ...
 * @author whx
 */
public class CmbSaleLine extends BeanLong<CmbSaleLine> {
	public static final TbCmb TB = new TbCmb(CmbSaleLine.class, "销售相关单据明细");
	...
	public enum T implements IEnumFld {//@formatter:off
		...
		PRICE(SYS.PRICE),
		AMT(SYS.AMT),
		EXPENSES_SALE(SYS.EXPENSES_SALE),
		INF(TB.crtInf()),

...
public class PurPresentLine extends BeanPurLine<PurPresentLine> {
	public static final Tb TB = new Tb(PurPresentLine.class, "受赠单明细", "受赠单明细").setAutoLocal();

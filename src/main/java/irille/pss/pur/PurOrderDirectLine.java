...
public class PurOrderDirectLine extends BeanPurLine<PurOrderDirectLine> {
	public static final Tb TB = new Tb(PurOrderDirectLine.class, "采购直发单明细").setAutoLocal();
  ...
  private Short _rowVersion;	// 版本  SHORT
	...
	@Override
  public PurOrderDirectLine init(){
		super.init();

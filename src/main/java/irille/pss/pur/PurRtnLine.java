...
public class PurRtnLine extends BeanPurLine<PurRtnLine> {
	public static final Tb TB = new Tb(PurRtnLine.class, "退货单明细", "退货单明细").setAutoLocal();

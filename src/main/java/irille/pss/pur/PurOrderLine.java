...
public class PurOrderLine extends BeanPurLine<PurOrderLine> {
	public static final Tb TB = new Tb(PurOrderLine.class, "采购订单明细", "采购订单明细").setAutoLocal();

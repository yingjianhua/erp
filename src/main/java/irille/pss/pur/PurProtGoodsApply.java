...
public class PurProtGoodsApply extends BeanForm<PurProtGoodsApply> {
	public static final Tb TB = new Tb(PurProtGoodsApply.class, "供应商货物协议申请单")
  ...
  //方法----------------------------------------------
  public static PurProtGoodsApply loadUniqueCode(boolean lockFlag,String code) {
    return (PurProtGoodsApply)loadUnique(T.IDX_CODE,lockFlag,code);
  }
  public static PurProtGoodsApply chkUniqueCode(boolean lockFlag,String code) {
    return (PurProtGoodsApply)chkUnique(T.IDX_CODE,lockFlag,code);
  }
  public Long getPkey(){
    return _pkey;
  }

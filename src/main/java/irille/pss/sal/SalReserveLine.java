...
public class SalReserveLine extends BeanGoods<SalReserveLine> {
	public static final Tb TB = new Tb(SalReserveLine.class, "存货保留单明细").setAutoLocal();

	public enum T implements IEnumFld {//@formatter:off
		CMB_GOODS_QTY(CmbGoods.fldFlds()),
	...
	static { //在此可以加一些对FLD进行特殊设定的代码
		T.CMB_GOODS_QTY.getFld().getTb().lockAllFlds();//加锁所有字段,不可以修改
	}
	//@formatter:on

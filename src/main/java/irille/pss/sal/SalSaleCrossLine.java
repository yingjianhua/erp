...
public class SalSaleCrossLine extends BeanSaleLine<SalSaleCrossLine> {
	public static final Tb TB = new Tb(SalSaleCrossLine.class, "跨公司销售单明细").setAutoLocal();

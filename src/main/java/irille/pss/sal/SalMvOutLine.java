...
public class SalMvOutLine extends BeanSaleLine<SalMvOutLine> {
	public static final Tb TB = new Tb(SalMvOutLine.class, "调出单明细").setAutoLocal();

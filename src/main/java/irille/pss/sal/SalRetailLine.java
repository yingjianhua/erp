...
public class SalRetailLine extends BeanSaleLine<SalRetailLine> {
	public static final Tb TB = new Tb(SalRetailLine.class, "销售零售单明细").setAutoLocal();

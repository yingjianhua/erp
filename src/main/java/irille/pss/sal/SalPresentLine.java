...
public class SalPresentLine extends BeanSaleLine<SalPresentLine> {
	public static final Tb TB = new Tb(SalPresentLine.class, "赠送单明细", "赠送单明细").setAutoLocal();

	public enum T implements IEnumFld {//@formatter:off
		CMB_GOODS_PRICE(CmbSaleLine.fldFlds()),

...
public class SalSaleDirectLine extends BeanSaleLine<SalSaleDirectLine> {
	public static final Tb TB = new Tb(SalSaleDirectLine.class, "直销单明细").setAutoLocal();

...
public class SalRtnLine extends BeanSaleLine<SalRtnLine> {

	public static final Tb TB = new Tb(SalRtnLine.class, "销售退货单明细", "销售退货单明细").setAutoLocal();

	public enum T implements IEnumFld {//@formatter:off
		CMB_GOODS_COST(CmbSaleLine.fldFlds()),
		PRICE_OLD(SYS.PRICE, "原价"),
  ...
  private BigDecimal _priceOld;	// 原价  DEC(14,4)
  private Short _rowVersion;	// 版本  SHORT

	@Override
  public SalRtnLine init(){
		super.init();

...
public class CstSalInvoiceLine extends BeanGoodsPrice<CstSalInvoiceLine> {
	public static final Tb TB = new Tb(CstSalInvoiceLine.class, "销售发票汇总单明细").setAutoLocal();

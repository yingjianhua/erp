...
public class CstMvInvoiceOutLine extends BeanGoodsPrice<CstMvInvoiceOutLine> {
	public static final Tb TB = new Tb(CstMvInvoiceOutLine.class, "调出发票汇总单明细", "调出发票汇总单明细").setAutoLocal();

	public enum T implements IEnumFld {//@formatter:off
		CMB_GOODS_PRICE(CmbGoodsPrice.fldFlds()),
	...
	static { //在此可以加一些对FLD进行特殊设定的代码
		T.CMB_GOODS_PRICE.getFld().getTb().lockAllFlds();//加锁所有字段,不可以修改
	}
	//@formatter:on
  ...
  private Short _rowVersion;	// 版本  SHORT
	...
	@Override
  public CstMvInvoiceOutLine init(){
		super.init();

...
public class CstPurInvoiceRedLine extends BeanGoodsPrice<CstPurInvoiceRedLine> {
	public static final Tb TB = new Tb(CstPurInvoiceRedLine.class, "采购红字发票汇总单明细").setAutoLocal();
  ...
  private Short _rowVersion;	// 版本  SHORT
	...
	@Override
  public CstPurInvoiceRedLine init(){
		super.init();

...
public class CstOutRedLine extends BeanGoodsPrice<CstOutRedLine> {
	public static final Tb TB = new Tb(CstOutRedLine.class, "红字出库单明细表").setAutoLocal();

...
public class CstSalInvoiceRed extends BeanBill<CstSalInvoiceRed> {
	public static final Tb TB = new Tb(CstSalInvoiceRed.class, "销售红字发票汇总单").setAutoIncrement().addActIns().addActDel()
	...
	public void initTallyLines(TallyLines ls) {
		ls.addByAlias(gtCell(), this, Sal.SubjectAlias.SAL_PENDING.getCode()).set(_amt, Gl.ODirect.DR, null,
		    "销售红字发票汇总单(" + getCode() + ")");
		ls.addByAlias(gtCell(), this, Cst.SubjectAlias.CST_INCOME.getCode()).set(_amt, Gl.ODirect.CR, null,
		    "销售红字发票汇总单(" + getCode() + ")");
		/*ls.addByAlias(gtCell(), this, Cst.SubjectAlias.CST_TAX.getCode()).set(_amt.negate(), Gl.ODirect.CR, null,
		    "销售红字发票汇总单(" + getCode() + ")");*/
	}
  ...
  //方法----------------------------------------------
  public static CstSalInvoiceRed loadUniqueCode(boolean lockFlag,String code) {
    return (CstSalInvoiceRed)loadUnique(T.IDX_CODE,lockFlag,code);
  }
  public static CstSalInvoiceRed chkUniqueCode(boolean lockFlag,String code) {
    return (CstSalInvoiceRed)chkUnique(T.IDX_CODE,lockFlag,code);
  }
  public Long getPkey(){
    return _pkey;
  }

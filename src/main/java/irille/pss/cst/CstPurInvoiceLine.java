...
public class CstPurInvoiceLine extends BeanGoodsPrice<CstPurInvoiceLine> {
	public static final Tb TB = new Tb(CstPurInvoiceLine.class, "采购发票汇总单明细").setAutoLocal();

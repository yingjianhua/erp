...
public class CstPurInvoice extends BeanBill<CstPurInvoice> {
	public static final Tb TB = new Tb(CstPurInvoice.class, "采购发票汇总单").setAutoIncrement().addActIns().addActDel()
  ...
  //方法----------------------------------------------
  public static CstPurInvoice loadUniqueCode(boolean lockFlag,String code) {
    return (CstPurInvoice)loadUnique(T.IDX_CODE,lockFlag,code);
  }
  public static CstPurInvoice chkUniqueCode(boolean lockFlag,String code) {
    return (CstPurInvoice)chkUnique(T.IDX_CODE,lockFlag,code);
  }
  public Long getPkey(){
    return _pkey;
  }

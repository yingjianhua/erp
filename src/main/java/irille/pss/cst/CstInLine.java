 ...
 * 价格不一样，允许出现重复的商品
 * @author whx
 * @version 创建时间：2014年8月21日 上午11:24:30
 */
public class CstInLine extends BeanGoodsPrice<CstInLine> {
	public static final Tb TB = new Tb(CstInLine.class, "入库核算单明细").setAutoLocal();

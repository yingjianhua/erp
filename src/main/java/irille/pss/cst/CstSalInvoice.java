...
public class CstSalInvoice extends BeanBill<CstSalInvoice> {
	public static final Tb TB = new Tb(CstSalInvoice.class, "销售发票汇总单").setAutoIncrement().addActIns().addActDel()
	...
	public void initTallyLines(TallyLines ls) {
		...
		ls.addByAlias(gtCell(), this, Cst.SubjectAlias.CST_INCOME.getCode()).set(_amt, Gl.ODirect.CR, null,
		    "销售发票汇总单(" + getCode() + ")");
		/*ls.addByAlias(gtCell(), this, Cst.SubjectAlias.CST_TAX.getCode()).set(_amt, Gl.ODirect.CR, null,
		    "销售发票汇总单(" + getCode() + ")");*/
	}
  ...
  //方法----------------------------------------------
  public static CstSalInvoice loadUniqueCode(boolean lockFlag,String code) {
    return (CstSalInvoice)loadUnique(T.IDX_CODE,lockFlag,code);
  }
  public static CstSalInvoice chkUniqueCode(boolean lockFlag,String code) {
    return (CstSalInvoice)chkUnique(T.IDX_CODE,lockFlag,code);
  }
  public Long getPkey(){
    return _pkey;
  }

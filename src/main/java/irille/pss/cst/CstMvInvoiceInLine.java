...
public class CstMvInvoiceInLine extends BeanGoodsPrice<CstMvInvoiceInLine> {
	public static final Tb TB = new Tb(CstMvInvoiceInLine.class, "调入发票汇总单明细").setAutoLocal();
  ...
  private Short _rowVersion;	// 版本  SHORT
	...
	@Override
  public CstMvInvoiceInLine init(){
		super.init();

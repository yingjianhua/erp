...
public class CstSalInvoiceRedLine extends BeanGoodsPrice<CstSalInvoiceRedLine> {
	public static final Tb TB = new Tb(CstSalInvoiceRedLine.class, "销售红字发票汇总单明细").setAutoLocal();
  ...
  private Short _rowVersion;	// 版本  SHORT
	...
	@Override
  public CstSalInvoiceRedLine init(){
		super.init();

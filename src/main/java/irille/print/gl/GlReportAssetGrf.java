 ...
 * 
 */
public class GlReportAssetGrf extends GrfForm implements SheetVarsInf {
	static {
	...
	public void initItemsSection(GrfItemsSection is, GrfSectionItem ph,
		...
		Sheet line6 = rh.getSheet().newInnerSheet(7, 1, new double[] { 1.2 }, 3.53, 0.65, 2.4, 2.42, 3.52, 0.65, 2.42, 2.42);
		...
		rh.AddItem("StaticBox", "asset", "负债和所有者权益\\r\\n（或股东权益）", line6.cellLocationSizeAbs(1,5), OAlign.MIDDLE_CENTER).addExp("BorderStyles", "[DrawLeft|DrawTop]");
	...
	public void initSheetPrint(SheetPrint sp) {
		...
		sp.setGroupHeader(new double[] {0}, 3.55, 0.65, 2.4, 2.4, 3.55, 0.65, 2.4, 2.4);
	...
	private static class MyDetailGrid extends GrfFormLine {
		public MyDetailGrid(GrfForm parent) {
			super(
					...
					new double[] { 3.55, 0.65, 2.4, 2.4, 3.55, 0.65, 2.4, 2.4},
					null,null,null,null
					);
			...
			getColumnContent().setGrowToNextRow(new GrfExp("F"));

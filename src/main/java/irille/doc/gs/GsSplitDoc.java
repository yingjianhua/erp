...
import irille.dep.gs.EGsSplit;
import irille.pub.doc.DocTran;
import irille.pub.html.EMCrt;

public class GsSplitDoc extends DocTran {
	public static EMCrt EXT = new EGsSplit().crtExt();
	public static DocTran DOC = new GsSplitDoc().init();
	...
	public static DocFld FLD_m_amt=DOC.getFld("m_amt");	//金额
	public static DocFld FLD_m_amtCost=DOC.getFld("m_amtCost");	//合计费用
	public static DocTb TB_m=DOC.getTb("TB_m");	//拆分单

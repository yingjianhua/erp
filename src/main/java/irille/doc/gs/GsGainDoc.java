...
public class GsGainDoc extends DocTran {
	public static EMCrt EXT = new EGsGain().crtExt();
	public static DocTran DOC = new GsGainDoc().init();
	...
	public static DocTb TB_m=DOC.getTb("TB_m");	//盘盈单
